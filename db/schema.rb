...
ActiveRecord::Schema.define(version: 2021_03_06_122201) do
  ...
  create_table "delivery_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchased_item_id"], name: "index_delivery_addresses_on_purchased_item_id"
  end
  ...
  add_foreign_key "delivery_addresses", "purchased_items"
